...
#define LR1121_DEFAULT_LORA_SF LR1121_LORA_SF7
#define LR1121_DEFAULT_LORA_BW LR1121_LORA_BW_125
#define LR1121_DEFAULT_LORA_CR LR1121_LORA_CR_4_5
...
#define LR1121_SETSLEEP_PARAMS 5
#define LR1121_SETSLEEP_CONF_PARAM 0
#define LR1121_SETSLEEP_CONF_RETEN_SHIFT 0
#define LR1121_SETSLEEP_CONF_RETEN_DISABLE (0 << LR1121_SETSLEEP_CONF_RETEN_SHIFT)
#define LR1121_SETSLEEP_CONF_RETEN_ENABLE (1 << LR1121_SETSLEEP_CONF_RETEN_SHIFT)
#define LR1121_SETSLEEP_CONF_WAKE_SHIFT 1
#define LR1121_SETSLEEP_CONF_WAKE_DISABLE (0 << LR1121_SETSLEEP_CONF_WAKE_SHIFT)
#define LR1121_SETSLEEP_CONF_WAKE_ENABLE (1 << LR1121_SETSLEEP_CONF_WAKE_SHIFT)
#define LR1121_SETSLEEP_TIMEOUT_PARAM 1
#define LR1121_SETSLEEP_TIMEOUT_PARAMS 4
#define LR1121_SETSLEEP_NO_TIMEOUT 0x00000000
...
#define LR1121_SETREGULATORMODE_DISABLE 0
#define LR1121_SETREGULATORMODE_ENABLE 1

/* Calibrate Function */

#define LR1121_CALIBRATE 0x010F
#define LR1121_CALIBRATE_LF_RC_EN (1 << 0)
#define LR1121_CALIBRATE_HF_RC_EN (1 << 1)
#define LR1121_CALIBRATE_PLL_EN (1 << 2)
#define LR1121_CALIBRATE_ADC_EN (1 << 3)
#define LR1121_CALIBRATE_IMG_EN (1 << 4)
#define LR1121_CALIBRATE_PLL_TX_EN (1 << 5)

/* CalibrateImage */

#define LR1121_CALIBRATEIMAGE 0x0111
#define LR1121_CALIBRATEIMAGE_PARAMS 2
...
#define LR1121_SETPACONFIG_PASEL 0
#define LR1121_SETPACONFIG_REGPASEL 1
#define LR1121_SETPACONFIG_PADUTYCYCLE_PARAM 2
#define LR1121_SETPACONFIG_PAHPSEL 3
...
#define LR1121_WRITEBUFFER_PARAMS 1
#define LR1121_WRITEBUFFER_DATA_PARAM 0

/* ReadBuffer Function */

#define LR1121_READBUFFER 0x010A
/* All of these below are uneeded */
...
/* SetDioIrqParams TODO */

#define LR1121_SETDIOIRQPARAMS 0x0113
#define LR1121_SETDIOIRQPARAMS_PARAMS 8 /* Takes LR1121_IRQ_x bit masks */
#define LR1121_SETDIOIRQPARAMS_IRQ1TOENABLE_PARAM 0
#define LR1121_SETDIOIRQPARAMS_IRQ1TOENABLE_PARAMS 4
#define LR1121_SETDIOIRQPARAMS_IRQ2TOENABLE_PARAM 4
#define LR1121_SETDIOIRQPARAMS_IRQ2TOENABLE_PARAMS 4

/* SetDIOAsRfSwitchCtrl */

#define LR1121_SETDIORFSWCTRL 0x0112
#define LR1121_SETDIORFSWCTRL_PARAMS 8
#define LR1121_SETDIORFSWCTRL_ENABLE_PARAM 0
#define LR1121_SETDIORFSWCTRL_STDBY_CFG_PARAM 1
#define LR1121_SETDIORFSWCTRL_RX_CFG_PARAM 2
#define LR1121_SETDIORFSWCTRL_TX_CFG_PARAM 3
#define LR1121_SETDIORFSWCTRL_TXHPCFG_PARAM 4
#define LR1121_SETDIORFSWCTRL_TXHFCFG_PARAM 5
...
#define LR1121_CLEARIRQSTATUS_PARAMS 1
#define LR1121_CLEARIRQSTATUS_CLEAR_PARAM 0
#define LR1121_CLEARIRQSTATUS_CLEAR_PARAMS 4
...
#define LR1121_SETMODULATIONPARAMS_PARAMS 4 /* Takes the corresponding LR1121_MODPARAMx_y */
...
#define LR1121_SETPACKETPARMS_PARAMS 6 /* Takes the corresponding LR1121_PKTPARAMx_y */
...
#define LR1121_STATUS_CHIPMODE_SHIFT (1)
#define LR1121_STATUS_CHIPMODE_MASK (0b111 << LR1121_STATUS_CHIPMODE_SHIFT)
#define LR1121_STATUS_RST_SHIFT (5)
#define LR1121_STATUS_RST_MASK (0b1111 << LR1121_STATUS_RST_SHIFT)
